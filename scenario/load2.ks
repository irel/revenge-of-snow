...
[locate x=77 y=157][button normal="kuang1" over="kuang2" storage="load2.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8"]
...
[locate x=77 y=368][button normal="kuang1" over="kuang2" storage="load2.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8+4"]
[locate x=363 y=370][button normal="kuang1" over="kuang2" storage="load2.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8+5"]
[locate x=648 y=370][button normal="kuang1" over="kuang2" storage="load2.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8+6"]
[locate x=937 y=371][button normal="kuang1" over="kuang2" storage="load2.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8+7"]
