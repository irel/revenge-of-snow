...
[locate x=381 y=175][button normal="&kag.getBookMarkFileNameAtNum((f.当前load页-1)*8+1)" over="&kag.getBookMarkFileNameAtNum((f.当前load页-1)*8+1)"   cond="checkdata((f.当前load页-1)*8+1)==true"]
[locate x=380 y=300]
...
[locate x=94 y=385][button normal="&kag.getBookMarkFileNameAtNum((f.当前load页-1)*8+4)" over="&kag.getBookMarkFileNameAtNum((f.当前load页-1)*8+4)"   cond="checkdata((f.当前load页-1)*8+4)==true"]
[locate x=94 y=510]
...
[locate x=380 y=386][button normal="&kag.getBookMarkFileNameAtNum((f.当前load页-1)*8+5)" over="&kag.getBookMarkFileNameAtNum((f.当前load页-1)*8+5)"   cond="checkdata((f.当前load页-1)*8+5)==true"]
[locate x=380 y=510]
...
[locate x=665 y=386][button normal="&kag.getBookMarkFileNameAtNum((f.当前load页-1)*8+6)" over="&kag.getBookMarkFileNameAtNum((f.当前load页-1)*8+6)"   cond="checkdata((f.当前load页-1)*8+6)==true"]
[locate x=665 y=510]
...
[locate x=77 y=157][button normal="kuang1" over="kuang2" storage="save.ks" target=*存储 exp="tf.存档编号=(f.当前load页-1)*8"]
...
[locate x=937 y=159][button normal="kuang1" over="kuang2" storage="save.ks" target=*存储 exp="tf.存档编号=(f.当前load页-1)*8+3"]
[locate x=77 y=368][button normal="kuang1" over="kuang2" storage="save.ks" target=*存储 exp="tf.存档编号=(f.当前load页-1)*8+4"]
[locate x=363 y=370][button normal="kuang1" over="kuang2" storage="save.ks" target=*存储 exp="tf.存档编号=(f.当前load页-1)*8+5"]
[locate x=648 y=370][button normal="kuang1" over="kuang2" storage="save.ks" target=*存储 exp="tf.存档编号=(f.当前load页-1)*8+6"]
[locate x=937 y=371][button normal="kuang1" over="kuang2" storage="save.ks" target=*存储 exp="tf.存档编号=(f.当前load页-1)*8+7"]
[stoptrans]
