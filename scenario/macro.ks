...
[sysbutton name="logb"  exp="kag.onShowHistoryMenuItemClick()" normal="logb1.png" over="logb2.png" enterse="yidong" clickse="dianji" x=414 y=6   entersebuf=3  clicksebuf=3 ]
